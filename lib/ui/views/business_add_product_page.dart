...
class BusinessAddProductPage extends StatefulWidget {
  const BusinessAddProductPage({super.key});

  @override
  State<BusinessAddProductPage> createState() => _BusinessAddProductPage();
}

class _BusinessAddProductPage extends State<BusinessAddProductPage> {
